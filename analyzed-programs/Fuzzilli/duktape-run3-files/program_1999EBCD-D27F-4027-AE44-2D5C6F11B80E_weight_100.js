...
new Uint32Array(12);
new Int8Array(1);
const v15 = [1.133387069177899e+308,906458.530439833];
function F16(a18, a19) {
    if (!new.target) { throw 'must be called with new'; }
    this.a = a19;
}
new F16(F16, v15);
const v21 = [-1.0,9.6145943398868,-932670.2675114713];
function f22() {
    return f22;
}
function f23(a24) {
    ...
    const v46 = new F44(-9007199254740991, "symbol");
    new ArrayBuffer(v46, v46, -1000.0, "undefined");
    const o49 = {
    };
    ...
    const v127 = Float64Array();
    let v129;
    try { v129 = v127["n"](); } catch (e) {}
