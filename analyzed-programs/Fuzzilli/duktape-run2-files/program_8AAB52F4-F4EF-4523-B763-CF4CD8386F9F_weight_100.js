const v0 = [-268435456,6,-9007199254740991,-2147483647,7,-7,268435440,1616274058];
...
[11919,-5249];
const v8 = [4746];
[9007199254740992,2,10000,726703004];
[16,31836,-11,2147483648,-227357358,-7,20239];
const v11 = [-9007199254740991,646665548];
const v12 = [v6,v1,v6];
[v12,[v1],v8];
function f15() {
}
function f19(a20) {
    const o37 = {
        set a(a22) {
            [this,f15,"n8FV","byteLength",v12,a22,a22];
            [[f15]];
        },
        o(a27) {
            new a27(this, this, a20);
            let v31 = 1000000000.0;
            FinalizationRegistry.trunc(v2);
            v31--;
            FinalizationRegistry.asin(v31);
            1024 || FinalizationRegistry.atan(1024, v11);
            return "byteLength";
        },
    };
    return o37;
