...
let v54 = [19472,65536,-9223372036854775808,4294967296,4294967295,3,1692527085,-4294967295,-1073741824,2147483649];
const v55 = [512,-6,6];
if (v55 > -4096) {
    v54 = v55;
}
...
function F63(a65, a66) {
    if (!new.target) { throw 'must be called with new'; }
    ("Pj2i").replace(a66, "Pj2i");
}
const v68 = [3.0,1000000.0,0.02045556907611057];
if (v68 < v31) {
    ...
    v68[Symbol.search] = v52;
}
const o83 = {
    [-1.0508092330130747]: -1.0508092330130747,
};
const v86 = new f17();
for (let i = 0; i < 5; i++) {
    v86[9] &= -10574;
