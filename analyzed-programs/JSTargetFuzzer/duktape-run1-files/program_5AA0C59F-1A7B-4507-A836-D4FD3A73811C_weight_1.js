...
const v38 = new Float32Array(109);
for (let i = 0; i < 5; i++) {
...
delete t27[1680];
const v49 = [-54193,64,-65536,16];
v38[11] *= 0;
v4[2652] ^= -4.542250198511928;
new Float32Array(1539);
new Uint8Array(10);
new Int8Array(255);
v49.lastIndexOf(3.0, 4096);
let v63 = 0;
do {
    const o64 = {
    };
    ...
    const v72 = [-9.448964787333276e+307,-1e-15,-1000000000000.0,1000000000000.0];
    v72.concat(-1024, f71, v72, this, Array(252));
    new Proxy(v21, o64);
    v63++;
} while (v63 < 5)
